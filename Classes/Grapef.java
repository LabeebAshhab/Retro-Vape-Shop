...
public class Grapef extends JFrame
{
    private Container c;
    ...
    public Grapef()
    {
        ...
        bc = new JLabel("Battery capacity: 600mah");
        ...
        vs = new JLabel("Vapespan: 4500 puff");
        ...
        price = new JLabel("Price: 1900 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Grapefreetone.jpg"));
