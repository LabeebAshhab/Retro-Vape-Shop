...
public class Wotofoc extends JFrame
{
    private Container c;
    ...
    public Wotofoc()
    {
        ...
        price = new JLabel("Price: 2250 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Wotofocherry.jpg"));
