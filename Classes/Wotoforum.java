...
public class Wotoforum extends JFrame
{
    private Container c;
    ...
    {	
        ...
        bc = new JLabel("Battery capacity: 550mah");
		...
		img = new ImageIcon(getClass().getResource("/products/Wotoforum.jpg"));
