...
public class Mintf extends JFrame
{
    private Container c;
    ...
    public Mintf()
    {
        ...
        bc = new JLabel("Battery capacity: 950mah");
        ...
        vs = new JLabel("Vapespan: 1500 puff");
        ...
        price = new JLabel("Price: 1800 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Mintfreetone.jpg"));
