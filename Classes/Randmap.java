...
public class Randmap extends JFrame
{
    private Container c;
    ...
    public Randmap()
    {
        ...
        bc = new JLabel("Battery capacity: 1000mah");
        ...
        vs = new JLabel("Vapespan: 7000 puff");
        ...
        price = new JLabel("Price: 2000 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Randmapple.jpg"));
