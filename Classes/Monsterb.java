...
public class Monsterb extends JFrame
{
    private Container c;
    ...
    public Monsterb()
    {
        ...
        bc = new JLabel("Battery capacity: 1200mah");
        ...
        vs = new JLabel("Vapespan: 6000 puff");
        ...
        price = new JLabel("Price: 2400 BDT");
        price.setBounds(540, 610, 150, 40);
		...
		img = new ImageIcon(getClass().getResource("/products/Monsterberry.jpg"));
