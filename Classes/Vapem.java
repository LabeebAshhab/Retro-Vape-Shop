...
public class Vapem extends JFrame
{
    private Container c;
    ...
    public Vapem()
    {
        ...
        vs = new JLabel("Vapespan: 4000 puff");
        ...
        price = new JLabel("Price: 1700 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Vapenginmars.jpg"));
