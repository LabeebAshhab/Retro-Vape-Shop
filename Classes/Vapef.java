...
public class Vapef extends JFrame
{
    private Container c;
    ...
    public Vapef()
    {
        ...
        this.setTitle("Vapengin Mixed Fruit");
        ...
        bc = new JLabel("Battery capacity: 500mah");
        ...
        vs = new JLabel("Vapespan: 5500 puff");
        ...
        price = new JLabel("Price: 1740 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Vapenginfruity.jpg"));
