...
public class NKDm extends JFrame
{
    private Container c;
    ...
    public NKDm()
    {
        ...
        bc = new JLabel("Battery capacity: 860mah");
        ...
        price = new JLabel("Price: 2100 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/NKDmax.jpg"));
