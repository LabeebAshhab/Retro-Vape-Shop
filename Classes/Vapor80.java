...
public class Vapor80 extends JFrame
{
    private Container c;
    ...
    public Vapor80()
    {
        ...
        bc = new JLabel("Battery Capacity: 1865mah");
        ...
        vs = new JLabel("vapespan: 8500 puff per pod");
        ...
        price = new JLabel("Price: 4850 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Vapor80.jpg"));
