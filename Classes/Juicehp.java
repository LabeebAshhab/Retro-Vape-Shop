...
public class Juicehp extends JFrame
{
    private Container c;
    ...
    public Juicehp()
    {
        ...
        bc = new JLabel("Battery capacity: 580mah");
        ...
        price = new JLabel("Price: 2300 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Juiceheadpeach.jpg"));
