...
public class Cali extends JFrame
{
    private Container c;
    ...
    public Cali()
    {
        ...
        bc = new JLabel("Battery capacity: 570mah");
        ...
        price = new JLabel("Price: 2500 BDT");
		...
		img = new ImageIcon(getClass().getResource("/products/Caliburn.jpg"));
